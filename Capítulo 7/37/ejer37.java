...
public class ejer37 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("*** Por favor, ingrese en su programa una instruccion ***");
        ...
        while (n != -9999) {
            ...
            if (n != -9999) {
                if (codigoDeOperacion == 10 || codigoDeOperacion == 11 || codigoDeOperacion == 30
                        || codigoDeOperacion == 31 || codigoDeOperacion == 32 || codigoDeOperacion == 33
                        || codigoDeOperacion == 20 || codigoDeOperacion == 21 || codigoDeOperacion == 43) {
        ...
        System.out.println("*** Carga completada de programa ***");
        System.out.println("*** Inicio de ejecucion del programa ***");
        ...
        for (int x = 0; x <= z; x++) {
            ...
            switch (m1[x]) {
                ...
                case 30:
                    System.out.print("Ingrese un numero entero a sumar: ");
                    n = input.nextInt();
                ...
                case 31:
                    System.out.print("Ingrese un numero entero a restar: ");
                    n = input.nextInt();
                    memoria[m2[x]] = memoria[m2[x]] - n;
                    break;
                case 32:
                    System.out.print("Ingrese un numero entero a dividir: ");
                    n = input.nextInt();
                    memoria[m2[x]] = memoria[m2[x]] / n;
                    break;
                case 33:
                    System.out.print("Ingrese un numero entero a multipicar: ");
                    n = input.nextInt();
                    memoria[m2[x]] = memoria[m2[x]] * n;
                    break;
        ...
        System.out.println("*** Comienzo de impresion de memoria ***");
